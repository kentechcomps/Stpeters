...
const ManageTeachers = () => {
  ...
  const fetchTeachers = async () => {
    ...
    if (error) {
      ...
      setErrorMessage("Failed to load teachers. Check console for details.");
    } else {
      setTeachers(data || []);
    }
  };
  ...
  const handleUpdate = async () => {
    ...
    if (error) {
      ...
      setTeachers(
        teachers.map((t) =>
          t.id === editTeacher.id ? { ...t, ...editTeacher } : t
        )
      );
      setEditTeacher(null);
      setErrorMessage("");
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <nav className="flex items-center space-x-1 text-sm text-gray-600 mb-6 font-medium">
        ...
        <span className="text-gray-400">/</span>
        <span className="font-semibold text-purple-700">Manage Teachers</span>
      </nav>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            View, edit, and manage teacher records efficiently
          </p>
        </div>
      </div>
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                <span className="font-semibold text-gray-800">
                  {confirmDelete.full_name || "this teacher"}
                </span>

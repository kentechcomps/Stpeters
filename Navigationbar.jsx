...
import './Navigationbar'; // Assuming you have a CSS file for styles
    ...
    <Banner />
      ...
      >
        ...
        <div className={`toggle w-full md:w-auto md:flex text-right text-bold ${isOpen ? 'block' : 'hidden'} md:block`}>
          ...
          <a  className="block md:inline-block hover:text-gray-300 px-3 py-3 text-black"
          style={{
            fontFamily: 'Roboto, sans-serif'
          }}
          ></a>

          <a href="#aboutus" className="block md:inline-block hover:text-gray-300 px-3 py-3 text-purple-600 font-medium"
          style={{
            fontFamily: 'Roboto, sans-serif'
          }}
          >About</a>
